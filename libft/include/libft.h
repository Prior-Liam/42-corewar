...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/02/21 19:06:35 by zfeng             #+#    #+#             */
/*   Updated: 2018/05/22 22:40:31 by ysibous          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_btree_apply_inorder(t_btree *root,
											void (*applyf)(void *));
void				ft_btree_apply_preorder(t_btree *root,
											void (*applyf)(void *));
void				ft_btree_apply_postorder(t_btree *root,
											void (*applyf)(void *));
